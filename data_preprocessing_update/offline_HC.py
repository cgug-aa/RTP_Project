...
dataset_path = os.getcwd()+'\\data\\pedestrian\\___ecfd1086a6934ae08b555b3ae880d31e'
...
grid_df.to_csv('grid_information_with_paths_HC.csv', index=False)
...
# Save or show map
m.save('south_korea_grid_map_with_subdivided_paths_HC.html')